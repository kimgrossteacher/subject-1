...
public class Phone {
   ...
   String popularitory="0 stars";
   public Phone(String phoneBrand, int year){ 
        name=phoneBrand; 
        yearMade=year; 
    };
    public String toString (){
        return name+" was made in "+yearMade+" camers on the phone "+howManyCamers+" This phone was made with "+materialsUsed+" this phone has a rating of "+popularitory; //tells when I put in the words that are blue the text before it will print out
    };    
    ...
    public void starRating(String rating){
        popularitory=rating;
    }
}
